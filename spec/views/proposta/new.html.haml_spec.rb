...
RSpec.describe "proposta/new", :type => :view do
  before(:each) do
    assign(:propostum, Propostum.new(
      :valor => 1.5,
      :status => "MyString",
      :imovel => nil,
      :usuario => nil
  ...
  it "renders new propostum form" do
    render

    assert_select "form[action=?][method=?]", proposta_path, "post" do
